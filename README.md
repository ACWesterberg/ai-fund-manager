...
- **Learns from realised outcomes** — decisions are scored at a mandate-chosen horizon (28 days), each thesis is judged on whether it *held* or merely *paid*, and the resulting lessons are injected into later prompts. Once enough outcomes accumulate, DSPy/MIPROv2 compiles an optimized decision-guidance block
